...
const outputPdfPath = path.resolve(process.cwd(), 'docs/flydea-govtech-overview-dengue.pdf');
const screenshotsDir = path.resolve(process.cwd(), 'docs/screenshots/govtech');

async function generatePdf() {
  console.log('Iniciando compilação do PDF institucional/técnico premium do FlyDea (Versão Combate à Dengue)...');
...
<head>
  <meta charset="UTF-8">
  <title>FlyDea GovTech - Visão Geral do Sistema (Combate à Dengue)</title>
...
<body class="bg-slate-100 text-slate-800 antialiased leading-relaxed">
  ...
  <div class="pdf-page text-white relative" style="background: linear-gradient(135deg, #0e1c31 0%, #152b4a 60%, #070e18 100%);">
    ...
    <div class="border-t border-white/10 pt-8 flex justify-between items-end z-10 text-slate-400 text-sm">
      ...
      <div class="text-right">
        ...
        <p class="text-xs">Documento Técnico e Comercial • Módulo Dengue</p>
      </div>
    </div>
  </div>
    ...
    <div class="grid grid-cols-2 gap-8 mb-6">
      <div>
        ...
        <ul class="space-y-2 text-xs text-slate-600">
          ...
          <li class="flex justify-between border-b pb-1">
            <span class="font-medium text-slate-800">5. Módulos Operacionais (Core)</span>
            <span class="text-slate-400">Pág 5</span>
          </li>
          <li class="flex justify-between border-b pb-1 bg-blue-50/50 px-1 py-0.5 rounded">
            <span class="font-bold text-gov-700">6. Saúde Pública e Combate à Dengue</span>
            <span class="text-blue-600 font-bold">Pág 8</span>
          </li>
          <li class="flex justify-between border-b pb-1">
            <span class="font-medium text-slate-800">7. Demonstração Visual das Telas</span>
            <span class="text-slate-400">Pág 9</span>
          </li>
          <li class="flex justify-between border-b pb-1">
            <span class="font-medium text-slate-800">8. Benefícios e Diferenciais</span>
            <span class="text-slate-400">Pág 15</span>
          </li>
          <li class="flex justify-between border-b pb-1">
            <span class="font-medium text-slate-800">9. Casos de Uso e Evolução</span>
            <span class="text-slate-400">Pág 15</span>
          </li>
        </ul>
      </div>
  ...
  <!-- ================= PÁGINA 8: MÓDULOS 4 (SAÚDE PÚBLICA & COMBATE À DENGUE) ================= -->
  <div class="pdf-page">
    <div class="flex justify-between items-center border-b pb-4 mb-4">
      <h2 class="text-2xl font-bold text-gov-600 font-outfit">Módulos de Saúde Pública</h2>
      <span class="text-xs text-slate-400 font-medium">FlyDea GovTech Overview • Pág 8</span>
    </div>

    <div class="space-y-5 text-xs">
      <h3 class="text-xl font-bold text-gov-700 font-outfit">6. Saúde Pública e Combate à Dengue</h3>
      <p class="text-slate-600 leading-relaxed">
        O FlyDea incorpora o módulo de <strong>Combate à Dengue</strong> como uma extensão direta de sua inteligência geográfica e territorial. Em vez de operar como uma planilha à parte, as ações de controle de vetores são totalmente amarradas ao CTM e ao WebGIS, permitindo que a prefeitura mapeie, execute, audite e preste contas de campanhas contra focos com máxima eficiência em campo.
      </p>

      <div class="grid grid-cols-2 gap-4">
        <!-- 1. Mapa de Risco -->
        <div class="p-3 border border-slate-100 rounded-xl bg-slate-50/50">
          <h4 class="font-bold text-gov-600 text-xs mb-0.5">6.1. Mapa de Risco Espacial</h4>
          <p class="text-[10px] text-slate-500 leading-relaxed">
            Cruzamento dinâmico no WebGIS de denúncias, terrenos subnotificados, áreas alagadas e histórico de focos para traçar mapas térmicos de vulnerabilidade sanitária.
          </p>
        </div>

        <!-- 2. Denúncias Populares -->
        <div class="p-3 border border-slate-100 rounded-xl bg-slate-50/50">
          <h4 class="font-bold text-gov-600 text-xs mb-0.5">6.2. Ouvidoria & Denúncias Integradas</h4>
          <p class="text-[10px] text-slate-500 leading-relaxed">
            Munícipes registram focos ou acúmulo de água parada via Portal do Cidadão (Ouvidoria 156), com foto e localização GPS automática direcionada ao CTM.
          </p>
        </div>

        <!-- 3. Planejamento -->
        <div class="p-3 border border-slate-100 rounded-xl bg-slate-50/50">
          <h4 class="font-bold text-gov-600 text-xs mb-0.5">6.3. Planejamento Georreferenciado</h4>
          <p class="text-[10px] text-slate-500 leading-relaxed">
            Painel de controle para criação de campanhas localizadas: definição de equipe, cronograma, responsável técnico, drone e biolarvicidas (BTI) aplicados.
          </p>
        </div>

        <!-- 4. Drones e Relatórios -->
        <div class="p-3 border border-slate-100 rounded-xl bg-slate-50/50">
          <h4 class="font-bold text-gov-600 text-xs mb-0.5">6.4. Operação Aérea e Relatório Auto</h4>
          <p class="text-[10px] text-slate-500 leading-relaxed">
            Registro de planos de voo, fotos/vídeos aéreos dos focos captados por drones e geração automática de relatórios técnicos completos para prestação de contas.
          </p>
        </div>
      </div>

      <!-- Card do Grafo do Fluxo da Dengue -->
      <div class="bg-gov-900 text-slate-200 p-4 rounded-xl font-mono text-[10px] flex flex-col items-center justify-center border border-gov-800 my-2 space-y-1">
        <div class="text-blue-400 font-bold">FLUXO INTEGRADO DE SAÚDE PÚBLICA</div>
        <div class="text-slate-500">│</div>
        <div class="flex items-center space-x-2">
          <span class="bg-gov-800 px-2 py-0.5 rounded border border-slate-700 text-slate-300">Portal (Denúncia 156)</span>
          <span class="text-slate-500">▶</span>
          <span class="bg-gov-800 px-2 py-0.5 rounded border border-slate-700 text-slate-300">WebGIS/CTM (Mapa)</span>
          <span class="text-slate-500">▶</span>
          <span class="bg-gov-800 px-2 py-0.5 rounded border border-slate-700 text-slate-300">Vistoria (Validação)</span>
        </div>
        <div class="text-slate-500">│</div>
        <div class="flex items-center space-x-2">
          <span class="bg-blue-600 text-white font-bold px-2 py-0.5 rounded">Relatório (Contas)</span>
          <span class="text-slate-500">◀</span>
          <span class="bg-gov-800 px-2 py-0.5 rounded border border-slate-700 text-slate-300">Drone (Operação)</span>
          <span class="text-slate-500">◀</span>
          <span class="bg-gov-800 px-2 py-0.5 rounded border border-slate-700 text-slate-300">Ordens de Serviço</span>
        </div>
      </div>
    </div>
    ...
    <!-- Rodapé -->
    <div class="pdf-footer border-t border-slate-100 pt-3 text-center text-[10px] text-slate-400 font-outfit">
      FlyDea GovTech • Combate à Dengue Integrado à Inteligência Geográfica
    </div>
  </div>

  <!-- ================= PÁGINA 9: DEMO VISUAL 1 (PORTAL & LOGIN) ================= -->
  <div class="pdf-page">
    <div class="flex justify-between items-center border-b pb-4 mb-4">
    ...
    <div class="pdf-footer border-t border-slate-100 pt-2 text-center text-[10px] text-slate-400 font-outfit">
      Demonstração em Produção: http://labspaulo.site/ • Tenant: São Paulo • Pág 9
    </div>
  </div>

  <!-- ================= PÁGINA 10: DEMO VISUAL 2 (DASHBOARD & WEBGIS) ================= -->
  <div class="pdf-page">
    <div class="flex justify-between items-center border-b pb-4 mb-4">
      <h2 class="text-xl font-bold text-gov-600 font-outfit">Demonstração Visual das Telas</h2>
    ...
    <!-- Rodapé -->
    <div class="pdf-footer border-t border-slate-100 pt-2 text-center text-[10px] text-slate-400 font-outfit">
      Demonstração em Produção: http://labspaulo.site/ • Tenant: São Paulo • Pág 10
    </div>
  </div>

  <!-- ================= PÁGINA 11: DEMO VISUAL 3 (CTM PARCELAS & DETALHE) ================= -->
  <div class="pdf-page">
    <div class="flex justify-between items-center border-b pb-4 mb-4">
      <h2 class="text-xl font-bold text-gov-600 font-outfit">Demonstração Visual das Telas</h2>
    ...
    <!-- Rodapé -->
    <div class="pdf-footer border-t border-slate-100 pt-2 text-center text-[10px] text-slate-400 font-outfit">
      Demonstração em Produção: http://labspaulo.site/ • Tenant: São Paulo • Pág 11
    </div>
  </div>

  <!-- ================= PÁGINA 12: DEMO VISUAL 4 (LOGRADOUROS & VISTORIAS) ================= -->
  <div class="pdf-page">
    <div class="flex justify-between items-center border-b pb-4 mb-4">
      <h2 class="text-xl font-bold text-gov-600 font-outfit">Demonstração Visual das Telas</h2>
    ...
    <!-- Rodapé -->
    <div class="pdf-footer border-t border-slate-100 pt-2 text-center text-[10px] text-slate-400 font-outfit">
      Demonstração em Produção: http://labspaulo.site/ • Tenant: São Paulo • Pág 12
    </div>
  </div>

  <!-- ================= PÁGINA 13: DEMO VISUAL 5 (REURB & ALVARÁS) ================= -->
  <div class="pdf-page">
    <div class="flex justify-between items-center border-b pb-4 mb-4">
      <h2 class="text-xl font-bold text-gov-600 font-outfit">Demonstração Visual das Telas</h2>
  ...
  <!-- ================= PÁGINA 14: DEMO VISUAL 6 (RELATÓRIOS) ================= -->
  <div class="pdf-page">
    <div class="flex justify-between items-center border-b pb-4 mb-4">
      <h2 class="text-xl font-bold text-gov-600 font-outfit">Demonstração Visual das Telas</h2>
    ...
    <!-- Rodapé -->
    <div class="pdf-footer border-t border-slate-100 pt-2 text-center text-[10px] text-slate-400 font-outfit">
      Demonstração em Produção: http://labspaulo.site/ • Tenant: São Paulo • Pág 14
    </div>
  </div>

  <!-- ================= PÁGINA 15: BENEFÍCIOS E CASOS DE USO ================= -->
  <div class="pdf-page">
    <div class="flex justify-between items-center border-b pb-4 mb-4">
  ...
  <div class="pdf-page">
    <div class="flex justify-between items-center border-b pb-4 mb-4">
      ...
      <span class="text-xs text-slate-400 font-medium">FlyDea GovTech Overview • Pág 16</span>
    </div>
    ...
    <div class="pdf-footer border-t border-slate-200 pt-8 text-center text-xs font-outfit">
      ...
      <p class="mt-1 text-slate-400">Documento gerado automaticamente pelo motor de conformidade técnica em 22 de Maio de 2026</p>
    </div>
  </div>
