...
- dialog "Unhandled Runtime Error" [ref=e3]:
  - generic [ref=e4]:
    ...
    - generic [ref=e25]:
      ...
      - generic [ref=e27]:
        - link "src/components/maps/MiniMap.tsx (34:25) @ eval" [ref=e29] [cursor=pointer]:
          - generic [ref=e30]: src/components/maps/MiniMap.tsx (34:25) @ eval
          - img [ref=e31]
        - generic [ref=e35]: "32 | if (!mapContainer.current || mapConfig.current) return; 33 | > 34 | mapConfig.current = new maplibregl.Map({ | ^ 35 | container: mapContainer.current, 36 | style: 'https://basemaps.cartocdn.com/gl/positron-gl-style/style.json', 37 | center,"
