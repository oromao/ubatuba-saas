...
- Name: poc/checks/roles-smoke.spec.js >> @smoke @roles leitor menu limitado e sem escrita mobile
- Location: poc/checks/roles-smoke.spec.js:121:1

# Error details

```
Error: page.goto: net::ERR_ABORTED at http://172.233.188.166:3000/app/dashboard
Call log:
  - navigating to "http://172.233.188.166:3000/app/dashboard", waiting until "domcontentloaded"
