...
| T4-AUDIT | Codex | 2026-04-21 | Parcel audit repository now has tenant-isolation coverage; broader audit trail still pending. |
...
5. **T4-AUDIT** — PARTIAL (tenant-isolated `ParcelAuditRepository` filters and counts are now proved; broader audit trail still pending).
