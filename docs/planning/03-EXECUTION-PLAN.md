...
6. **T3-EMPTY-STATES** — PARTIAL (assets, logradouros, pgv/zonas, pgv/faces, ctm/mobiliario, ctm/parcelas, 156, ctm/vistorias, ambiental, levantamentos, modulos/compliance, cartas, and pgv/relatorio error/empty states proved; broader module coverage still pending).
