...
- **Agente:** Codex (2026-04-21) — `assets`, `logradouros`, `pgv/zonas`, `pgv/faces` e `ctm/mobiliario` agora mostram error/empty state explícitos com fallback testado; ainda faltam outros módulos do padrão.
