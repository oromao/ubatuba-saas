...
- **Agente:** Codex (2026-04-21) — `assets`, `logradouros`, `pgv/zonas`, `pgv/faces`, `ctm/mobiliario`, `ctm/parcelas`, `156`, `ctm/vistorias`, `ambiental`, `levantamentos` e `modulos/compliance` agora mostram error/empty state explícitos com fallback testado; ainda faltam outros módulos do padrão.
