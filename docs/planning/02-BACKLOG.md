...
- **Agente:** Codex (2026-04-21) — `assets`, `logradouros`, `pgv/zonas` e `pgv/faces` agora mostram error/empty state explícitos com fallback testado; ainda faltam outros módulos do padrão.
