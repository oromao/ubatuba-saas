...
export declare class PermitsWorksRepository {
    ...
    findOne(tenantId: string, query: any): Promise<(import("mongoose").Document<unknown, {}, PermitWorkRequestDocument, {}, {}> & PermitWorkRequest & import("mongoose").Document<import("mongoose").Types.ObjectId, any, any, Record<string, any>, {}> & Required<{
        _id: import("mongoose").Types.ObjectId;
    }> & {
        __v: number;
    }) | null>;
    update(tenantId: string, id: string, data: Partial<PermitWorkRequest>): Promise<(import("mongoose").Document<unknown, {}, PermitWorkRequestDocument, {}, {}> & PermitWorkRequest & import("mongoose").Document<import("mongoose").Types.ObjectId, any, any, Record<string, any>, {}> & Required<{
        _id: import("mongoose").Types.ObjectId;
    }> & {
        __v: number;
    }) | null>;
