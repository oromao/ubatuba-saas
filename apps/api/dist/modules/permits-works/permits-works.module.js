...
exports.PermitsWorksModule = PermitsWorksModule = __decorate([
    (0, common_1.Module)({
        imports: [projects_module_1.ProjectsModule, certificates_module_1.CertificatesModule, mongoose_1.MongooseModule.forFeature([{ name: permit_work_schema_1.PermitWorkRequest.name, schema: permit_work_schema_1.PermitWorkRequestSchema }])],
