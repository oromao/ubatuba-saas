...
let ParcelsService = (() => {
    ...
    let _classThis;
    var ParcelsService = _classThis = class {
        constructor(parcelsRepository, projectsService, parcelBuildingsService, parcelSocioeconomicService, parcelInfrastructureService, logradourosService, parcelAuditRepository, importBatchRepository) {
            ...
            this.logger = new common_1.Logger(ParcelsService.name);
        }
    ...
    __setFunctionName(_classThis, "ParcelsService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ParcelsService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ParcelsService = _classThis;
})();
