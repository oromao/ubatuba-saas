...
let ImportBatchRepository = (() => {
    ...
    let _classThis;
    var ImportBatchRepository = _classThis = class {
        ...
        async list(tenantId, projectId, options) {
            return this.importBatchModel
                .find({ tenantId: new mongoose_1.Types.ObjectId(tenantId), projectId: new mongoose_1.Types.ObjectId(projectId) })
                .sort({ createdAt: -1 })
    ...
    __setFunctionName(_classThis, "ImportBatchRepository");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ImportBatchRepository = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ImportBatchRepository = _classThis;
})();
