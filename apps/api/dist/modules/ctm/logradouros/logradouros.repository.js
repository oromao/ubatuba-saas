...
exports.LogradourosRepository = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const logradouro_schema_1 = require("./logradouro.schema");
const object_id_1 = require("../../../common/utils/object-id");
let LogradourosRepository = class LogradourosRepository {
    constructor(model) {
        this.model = model;
    }
...
exports.LogradourosRepository = LogradourosRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(logradouro_schema_1.Logradouro.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], LogradourosRepository);
//# sourceMappingURL=logradouros.repository.js.map