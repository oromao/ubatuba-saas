...
export declare class Citizen156Repository {
    ...
    findByProtocol(protocolNumber: string): Promise<(import("mongoose").Document<unknown, {}, CitizenCallDocument, {}, {}> & CitizenCall & import("mongoose").Document<import("mongoose").Types.ObjectId, any, any, Record<string, any>, {}> & Required<{
        _id: import("mongoose").Types.ObjectId;
    }> & {
        __v: number;
    }) | null>;
