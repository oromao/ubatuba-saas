...
let AssetsRepository = class AssetsRepository {
    constructor(model) {
        this.model = model;
    }
    list(tenantId, bbox) {
        ...
        return this.model.find({ tenantId: (0, object_id_1.asObjectId)(tenantId) }).exec();
    }
...
exports.AssetsRepository = AssetsRepository = __decorate([
