    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: alert_schema_1.EnvironmentalAlert.name, schema: alert_schema_1.EnvironmentalAlertSchema },
            ]),
        ],
        controllers: [alerts_controller_1.AlertsController],
        providers: [alerts_repository_1.AlertsRepository, alerts_service_1.AlertsService, cache_service_1.CacheService, redis_service_1.RedisService],
