...
exports.CemeteryRepository = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const object_id_1 = require("../../common/utils/object-id");
const cemetery_schema_1 = require("./cemetery.schema");
let CemeteryRepository = class CemeteryRepository {
    constructor(model) {
        this.model = model;
    }
    list(tenantId) {
...
exports.CemeteryRepository = CemeteryRepository;
exports.CemeteryRepository = CemeteryRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(cemetery_schema_1.CemeteryPlot.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], CemeteryRepository);
//# sourceMappingURL=cemetery.repository.js.map