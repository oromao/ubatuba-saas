...
exports.GisModule = GisModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: parcel_schema_1.Parcel.name, schema: parcel_schema_1.ParcelSchema }]),
        ],
        controllers: [gis_controller_1.GisController],
        providers: [gis_service_1.GisService, parcels_repository_1.ParcelsRepository],
