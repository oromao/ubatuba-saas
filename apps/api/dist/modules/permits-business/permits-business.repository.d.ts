...
export declare class PermitsBusinessRepository {
    ...
    findOne(tenantId: string, query: any): Promise<(import("mongoose").Document<unknown, {}, PermitBusinessRequestDocument, {}, {}> & PermitBusinessRequest & import("mongoose").Document<import("mongoose").Types.ObjectId, any, any, Record<string, any>, {}> & Required<{
        _id: import("mongoose").Types.ObjectId;
    }> & {
        __v: number;
    }) | null>;
    update(tenantId: string, id: string, data: Partial<PermitBusinessRequest>): Promise<(import("mongoose").Document<unknown, {}, PermitBusinessRequestDocument, {}, {}> & PermitBusinessRequest & import("mongoose").Document<import("mongoose").Types.ObjectId, any, any, Record<string, any>, {}> & Required<{
        _id: import("mongoose").Types.ObjectId;
    }> & {
        __v: number;
    }) | null>;
