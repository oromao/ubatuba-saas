...
const citizen_156_service_1 = require("../src/modules/citizen-156/citizen-156.service");
const repository = {
...
describe('Citizen156Service', () => {
    it('creates citizen call and links alert when provided', async () => {
        const service = new citizen_156_service_1.Citizen156Service(repository, projectsService, alertsService, cache);
...
//# sourceMappingURL=citizen-156.service.spec.js.map