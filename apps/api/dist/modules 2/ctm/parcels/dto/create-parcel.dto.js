...
let CreateParcelDto = (() => {
    ...
    return _a = class CreateParcelDto {
            constructor() {
        ...
        (() => {
            ...
            _sqlu_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            ...
            _geometry_decorators = [(0, class_validator_1.IsObject)()];
